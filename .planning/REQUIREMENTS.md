...
- [ ] **LOCK-01**: 玩家可以在支持的单箱、双箱、木桶和潜影盒上创建主锁牌，且主锁牌绑定到正确的受保护目标。
- [ ] **LOCK-02**: 玩家可以在已有主锁的目标上继续添加扩展授权牌，且只有锁主人或管理员绕过用户可以执行该操作。
- [ ] **LOCK-03**: 双箱的两个半边必须被视为同一把锁的共享目标，任一半边上的锁牌与授权都对整个双箱生效。
